...
try {
    ...
    # Update "## PowerShell Modules" table
    $modulesSection = Find-MarkdownSectionRange -Lines $lines -SectionHeader '{% hint style="info" %} The PowerShell Modules section is automatically updated from the public repository [realmjoin/realmjoin-runbooks](https://github.com/realmjoin/realmjoin-runbooks). {% endhint %}'
    ...
    $permissionsSection = Find-MarkdownSectionRange -Lines $lines -SectionHeader '## Permissions'
